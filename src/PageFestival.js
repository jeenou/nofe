  ...
  return (
    <div className="page-content">
      ...
      <div className="festival-info">
        <p>Nousiaisten Festarit järjestetään tänä vuonna Hämeenlinnassa, X suurella huvilalla 9.-11.8.2024. Festareille voi saapua perjantaina klo 17 alkaen ja poistuminen tapahtuu sunnuntaina viimeistään klo 12.</p>

        <p className="middle-text-red">
        <span className="middle-text-red">Liput</span>
        </p>
        ...
        <p>Pe-su: 50€<br />
        Pe-la: 30€ (yksi yömajoittuminen)<br />
        La-su: 25€ (yksi majoittuminen)<br />
        Käväsen vuan-lippu pe tai la: 20€ (ei majoittumista)<br />
        Sisänukkumapaikka (sänky tai patja): 5€</p>

        <p className="middle-text-red">
        <span className="middle-text-red">Majoitus</span>
        </p>
        ...
        <p className="middle-text-red">
        <span className="middle-text-red">Kyydit</span>
        </p>
        ...
        <p className="middle-text-red">
        <span className="middle-text-red">Ruokailu</span>
        </p>
        ...
        <p className="middle-text-red">
        <span className="middle-text-red">Juomat</span>
        </p>
      ...
      />
        ...
        <p className="middle-text-red">
        <span className="middle-text-red">Kylpy</span>
        </p>
        ...
        <p className="middle-text-red">
        <span className="middle-text-red">WC</span>
        </p>
        <p>Festaripaikalta löytyy sekä naisten, miesten että unisex-wc:t.</p>

        <p className="middle-text-red">
        <span className="middle-text-red">Kaikkien iloksi</span>
        </p>
